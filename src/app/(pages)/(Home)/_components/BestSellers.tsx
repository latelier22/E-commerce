...
export default async function BestSellers() {
  ...
  return (
    <div className='space-y-2'>
            <h3 className='pt-2 text-lg font-bold uppercase'>{getBestSellersProducts.data[0].attributes.title}</h3>
            {getBestSellersProducts.data[0].attributes.products.data.map(product => ( 
